# Memo: the one-line change Cinematic Combat needs in OpenMW Impact Effects
...
leave it out and let handlers suppress it. Cinematic Combat sets
`var.noSound = true` for the material so nothing changes audibly for anyone who
has not asked for it.

## Why it matters to us

Cinematic Combat puts a small light at the point of impact. Impact Effects'
